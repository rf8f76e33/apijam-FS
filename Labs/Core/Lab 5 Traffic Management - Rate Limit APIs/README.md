...
* Open up the **Develop** tab of your Payment API that you used in the previous lab.
...
* Create 2 new API Products that include this proxy, ‘**{your_initials}**\_Payments Bronze Product’ and ‘**{your_initials}**\_Payments Platinum Product’
